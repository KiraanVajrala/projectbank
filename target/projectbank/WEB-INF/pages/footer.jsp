...
<title>Footer</title>
>>>>>>> branch 'master' of https://github.com/KiraanVajrala/projectbank.git
<style>
div.container {
	width: 100%;
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<ul class="unstyled">
					<li><a href="${contextPath}/projectbank/login">Home</a></li>
					<li><a
						href="https://www.chase.com/digital/resources/about-chase">About
							Us</a></li>
					<li><a
						href="https://www.chase.com/digital/resources/customer-service">Contact</a></li>
				</ul>
			</div>
			<!-- end col-sm-2 -->
